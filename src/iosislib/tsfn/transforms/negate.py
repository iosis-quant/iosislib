...
from iosislib.core.tsfn import FrameSignature, ItemwiseUnaryTSFN, TSFNConfig, TimeAxis
from iosislib.tsfn.transforms._validation import validate_column_name, validate_distinct_columns


@dataclass(frozen=True)
class NegateConfig(TSFNConfig):
    input_column: str = "value"
    output_column: str = "negated"
...
class Negate(ItemwiseUnaryTSFN[NegateConfig]):
    VERSION = "0.1.0"
    CONFIG_CLS = NegateConfig
