...
_DESCRIPTIONS: dict[str, str] = {
    ...
    "transform.rolling_var": "Rolling variance over a window with ddof control.",
    "transform.rolling_cov": "Rolling covariance between two columns over a shared window.",
    "transform.rolling_cov_matrix": "Rolling N x N covariance matrix as a row-major array for Value-at-Risk.",
